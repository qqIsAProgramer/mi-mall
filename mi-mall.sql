...
CREATE TABLE `product`  (
    ...
    `product_title` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    `product_intro` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
    `product_picture` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
